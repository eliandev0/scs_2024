...
//require_once __DIR__ . "/../class/class.Medicos.php";

require_once __DIR__ . "/GetJSONTablaMedicos_Funciones.php";
...
echo json_encode(listadoTablaMedicos($textoBusqueda,$limit,$offset,$sortby,$order));
