...
<div class="modal fade" id="modalDatosEnfermero" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="modalFormularioEnfermeroLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-warning text-dark">
                <h4 class="modal-title" id="tituloModalFormularioDatosEnfermero"><i class="fa-solid fa-user-nurse"></i>
                    Crear/Editar Datos Enfermero</h4>
                <button type="button" class="btn-close text-warning btn-close-white" data-bs-dismiss="modal"
                    aria-label="Cerrar"></button>
            </div>
            <div id="modalFormularioDatosEnfermeroCuerpo" class="modal-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="d-flex justify-content-center">
                            <span id="feedbackFormCrearEditarDatosEnfermero" class="badge text-bg-danger"></span>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3"></div>
                </div>
            ...
            <div class="modal-footer bg-opacity-75 bg-warning-subtle">
                ...
                <button id="btnGuardarEnfermero" onclick="guardarEnfermero(this);" type="button" class="btn btn-success"><i
                        class="fa-solid fa-cloud-arrow-up"></i> Guardar Enfermero</button>
            </div>
        </div>
    </div>
</div>