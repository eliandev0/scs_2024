...
//require_once __DIR__ . "/../class/class.Pacientes.php";

require_once __DIR__ . "/GetJSONTablaPacientes_Funciones.php";
...
echo json_encode(listadoTablaPacientes($textoBusqueda,$limit,$offset,$sortby,$order));
